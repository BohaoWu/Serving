...
bool baidu::xvision::ExtractFrameBase::select_frame(const double frame_rate, const int64_t pre_frame_time, \
        const int64_t cur_frame_time, const size_t frame_index, const double fps, const int mode) {
    //TODO: select frame function flattens ffmpeg FPS filter
    bool ret = false;
    ...
    int i_frame_rate = std::round(frame_rate); // frame to int, 24.9999 will be 25, 24.02 will be 24
